...
# This script retrains the model using the last 1 week of data. 
# Specific to the period of July 24-31, 2025.
...
if __name__ == "__main__":
    ...
    ap.add_argument("--csv", default="data/processed/goes_july24-31_clean.csv")
    args = ap.parse_args()
    main(args.csv)
