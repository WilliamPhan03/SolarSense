...
def test_prediction_accuracy():
    ...
    # File paths
    forecast_file = os.path.join(project_root, 'data', 'processed', 'forecast_2025_08_07-2025_08_07.csv')
    actual_file = os.path.join(project_root, 'data', 'processed', 'august7_valid.csv')
